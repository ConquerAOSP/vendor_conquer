...
SOONG_CONFIG_NAMESPACES += conquerGlobalVars
SOONG_CONFIG_conquerGlobalVars += \
...
SOONG_CONFIG_NAMESPACES += conquerNvidiaVars
SOONG_CONFIG_conquerNvidiaVars += \
...
SOONG_CONFIG_conquerGlobalVars_has_legacy_camera_hal1 := $(TARGET_HAS_LEGACY_CAMERA_HAL1)
SOONG_CONFIG_conquerGlobalVars_ignores_ftp_pptp_conntrack_failure := $(TARGET_IGNORES_FTP_PPTP_CONNTRACK_FAILURE)
...
SOONG_CONFIG_conquerGlobalVars_additional_gralloc_10_usage_bits := $(TARGET_ADDITIONAL_GRALLOC_10_USAGE_BITS)
SOONG_CONFIG_conquerGlobalVars_bootloader_message_offset := $(BOOTLOADER_MESSAGE_OFFSET)
SOONG_CONFIG_conquerGlobalVars_target_init_vendor_lib := $(TARGET_INIT_VENDOR_LIB)
SOONG_CONFIG_conquerGlobalVars_target_ld_shim_libs := $(subst $(space),:,$(TARGET_LD_SHIM_LIBS))
...
ifneq ($(filter $(UM_PLATFORMS),$(TARGET_BOARD_PLATFORM)),)
SOONG_CONFIG_conquerQcomVars_qcom_soong_namespace := $(QCOM_SOONG_NAMESPACE)
endif
