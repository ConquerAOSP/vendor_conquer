...
CONQUER_VERSION := 4.0
CONQUER_VERSION_NAME := Raven
CONQUER_BUILD_VERSION := ConquerAOSP_$(CONQUER_VERSION_NAME)-$(CONQUER_VERSION)-$(CONQUER_BUILD)-$(CONQUER_HOST_TIME)-$(CONQUER_BUILD_TYPE)
...
PRODUCT_SYSTEM_DEFAULT_PROPERTIES += \
   ...
   ro.conquer.build.date=$(CONQUER_BUILD_DATE)
